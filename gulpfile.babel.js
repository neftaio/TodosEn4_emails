...
// Exceute python script for create blade template
function bladetemplater() {
  exec('python laravel-templater.py', function (err, stdout, stderr) {
...
function inline() {
  return gulp.src('dist/**/*.html')
    ...
    .pipe(gulp.dest('dist'))
    .pipe(exec('python laravel-templater.py'));
}
